...
public class CurrencyConverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Convert.setBackground(new java.awt.Color(102, 0, 102));
        Convert.setFont(new java.awt.Font("Serif", 1, 18)); // NOI18N
        ...
        txtFrom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USD", "ETB" }));
        txtFrom.setToolTipText("");

        txtTo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ETB", "USD" }));
    ...
    private void ConvertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConvertActionPerformed
        ...
        if(txtFrom.getSelectedItem().toString()=="USD" && txtTo.getSelectedItem().toString()=="ETB"){
            convert = amount * 53.76;
            JOptionPane.showMessageDialog(this, "The amount is: "+convert.toString()+" ETB");
        }
        else if(txtFrom.getSelectedItem().toString()=="ETB" && txtTo.getSelectedItem().toString()=="USD"){
